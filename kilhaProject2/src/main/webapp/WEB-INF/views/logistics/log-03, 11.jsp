	...
	<section id="container">
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div id="graph-bar" style="display: none"></div>
				<div id="graph-line" style="display: none"></div>
				<div id="graph-area-line" style="display: none"></div>
				<div class="row">
					<div class="col-sm-3">
						<section class="panel">
