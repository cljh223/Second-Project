...
<div class="listBtns">
    <button type="button" class="btn btn-primary"><i class="ico ico-plus"></i> Ordered </button>
    <button type="button" class="btn btn-success"><i class="ico ico-checkmark2"></i> Confirmed </button>
    <button type="button" class="btn btn-info "><i class="fa fa-truck"></i> Shipped </button>
    <button type="button" class="btn btn-default "><i class="ico ico-close"></i> Rejected </button>
</div><br/>
