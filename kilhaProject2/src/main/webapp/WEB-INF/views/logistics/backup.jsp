...
<body>
		...
		<section id="main-content">
			<section class="wrapper">
				<div class="col-lg-4">
					<div class="btn-row">
						<div>
							<button data-toggle="button" class="btn btn-white" id="ware1Btn">
								<i class="fa fa-building-o "></i> 물류창고 1
							</button>
							<button data-toggle="button" class="btn btn-white" id="ware2Btn">
								<i class="fa fa-building-o "></i> 물류창고 2
							</button>
							<button data-toggle="button" class="btn btn-white" id="ware3Btn">
	...
	<script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?clientId=otf86aT1jDplHTHO4gPd&submodules=geocoder"></script>
	<script>
		$(function() {
			$("#ware1Btn").on('click', function() {
				alert("1번클릭");
