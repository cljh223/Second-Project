					...
					<div class="col-lg-12">
						<section class="panel">
							...
							<div class="panel-body">
								<form action="ordering" class="form-horizontal bucket-form"
									method="get">
									<div class="form-group">
										<label class="col-sm-3 control-label">Order Dept</label>
										<div class="col-sm-6">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">Goods</label>
										<div class="col-sm-6">
											<select class="form-control m-bot15" name="goods">
											...
											<div id="spinner4">
												<div class="input-group" style="width: 150px;">
													...
													<input type="text" class="spinner-input form-control"
														name="quantity" maxlength="3" readonly>
													<div class="spinner-buttons input-group-btn">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<select class="form-control m-bot15" name="office">
												<option value="영업소 1">영업소 1</option>
												<option value="영업소 2">영업소 2</option>
												<option value="영업소 3">영업소 3</option>
												<option value="영업소4">영업소4</option>
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">Delievery Date</label>
										<div class="col-md-4">
