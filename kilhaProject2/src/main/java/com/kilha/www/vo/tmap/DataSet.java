...
{
	public String shortestDataSet(int size) 
	{
		...
		shortest += ", \"startX\" : " + "\"" + lonlat.finalRoute_lon.get(0) + "\"";
		shortest += ", \"startY\" : " + "\"" + lonlat.finalRoute_lat.get(0) + "\"";
		shortest += ", \"startTime\" : " + "\"" + mTime + "\"";
		shortest += ", \"endName\" : \"도착\"";
		shortest += ", \"endX\" : " + "\"" + lonlat.finalRoute_lon.get(lonlat.finalRoute_lon.size() - 1) + "\"";
		shortest += ", \"endY\" : " + "\"" + lonlat.finalRoute_lat.get(lonlat.finalRoute_lat.size() - 1) + "\"";
		...
		for(int i = 1; i < size - 1; i++)
		{
			...
			shortest += "\"viaX\" : " + "\"" + lonlat.finalRoute_lon.get(i) + "\"" + ", ";
			shortest += "\"viaY\" : " + "\"" + lonlat.finalRoute_lat.get(i) + "\"";
			shortest += "},";
			pointId++;
		}
		shortest += "]";
